...
### 6.5 Viewing
- Any number of shares may be watched at once. Click a tile to subscribe, click again to unsubscribe. Each tile has a fullscreen button. Entering fullscreen on one share unsubscribes every other share; leaving fullscreen does nothing automatic. While a share fills the screen, clicking into it does not unsubscribe. When the share stops for any reason (sharer quit, peer unreachable, viewer left the call) fullscreen ends with it.
