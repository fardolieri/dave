...
**Amended 2026-09-24:** Safari 27 (iOS 27, released 2026-09-14) added `getDisplayMedia` on iPhone. PostHog showed the only mobile share so far from Mobile Safari 27.0, while six friends on Safari 26.6 saw the "not available" hint; the owner confirmed the iOS share worked well on the first try. Android Chrome and Android Firefox still lack it (no Android share recorded). The Publishing line above holds for the browsers of its date; publishing is no longer desktop-only. Sources: [Safari 27 release notes](https://developer.apple.com/documentation/safari-release-notes/safari-27-release-notes), [MDN browser-compat-data #30654](https://github.com/mdn/browser-compat-data/issues/30654).
